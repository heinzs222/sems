...
# Cartesia output format settings - Late 2025 best practice: request 8kHz directly!
CARTESIA_SAMPLE_RATE = 8000  # Request 8kHz to avoid resampling
                    ...
                    try:
                        ...
                        if msg_type == "chunk":
                            ...
                            if audio_b64:
                                ...
                                # Fast PCM 8kHz -> mu-law conversion (no resampling!)
